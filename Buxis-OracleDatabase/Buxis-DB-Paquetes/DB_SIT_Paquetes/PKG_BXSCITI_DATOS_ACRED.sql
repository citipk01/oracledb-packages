...
AS
   ...
   ******************************************************************************/
   ...
   IS
      ...
      l_descr           VARCHAR2 (50) := 'Proceso de datos de acreditación';
               ...
               LOOP
                  BEGIN
                     ...
                     THEN
                        ...
                        -- EGV - 03/08/2015 - Inicio - se mueve un poco más arriba
                        --> Blanqueo los importes
                        --g_rem_suj_ret := 0;
                        --g_con_no_grab := 0;
                        --g_retenciones := 0;
   ...
   EXCEPTION
      ...
      THEN
         ...
         p_resultado := 'El proceso finalizó con Errores. Ver Log.';
